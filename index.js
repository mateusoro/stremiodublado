...
var db = new sqlite3.Database('linhas.sqlite3');
...
Apify.main(async () => {
    ...
    const dat = await Apify.openDataset('some-name');
    await dat.pushData({foo: 'bar'});
    var manifest = {
        ...
        endpoint: "https://stremiodublado.herokuapp.com/stremio/v1",
